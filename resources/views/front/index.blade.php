                   ...
                   <!--    <a class="aa-browse-btn" href="#">Browse all Product <span class="fa fa-long-arrow-right"></span></a> -->
                    ...
                    <div class="tab-pane fade" id="electronics">
                       <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{asset('front_assets/electronics/electronic-1.png')}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">This is Title</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
        ...
        <div class="col-md-12">
          <div class="aa-client-brand-area">
            <ul class="aa-client-brand-slider">
              ...
              <li><a href="#"><img src="{{asset('front_assets/img/client-brand-java.png')}}" alt="java img"></a></li>
              <li><a href="#"><img src="{{asset('front_assets/img/client-brand-jquery.png')}}" alt="jquery img"></a></li>
              <li><a href="#"><img src="{{asset('front_assets/img/client-brand-joomla.png')}}" alt="html5 img"></a></li>
              <li><a href="#"><img src="{{asset('front_assets/img/client-brand-joomla.png')}}" alt="css3 img"></a></li>
              <li><a href="#"><img src="{{asset('front_assets/img/client-brand-joomla.png')}}" alt="wordPress img"></a></li>
            </ul>
          </div>
        </div>
      </div>
